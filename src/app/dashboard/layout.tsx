    ...
    <div className={styles.dashboardContainer}>
      ...
      <aside className={`${styles.sidebar} ${sidebarOpen ? styles.open : ""}`}>
        ...
        <nav className={styles.navLinks}>
          ...
          {(userRole === "koordinator_driver" || userRole === "admin" || userRole === "asman") && (
        ...
        <div className={styles.userSection}>
          ...
          <div className={styles.userInfo}>
            <div className={styles.userName}>{userName || user.displayName || "Pengguna UMRO"}</div>
                      ...
                      pathname === '/dashboard/approvals' ? 'Panel Persetujuan' :
                        pathname === '/dashboard/vehicles' ? 'Peminjaman Kendaraan' :
                          pathname === '/dashboard/item-requests' ? 'Permintaan Barang' :
                            pathname === '/dashboard/maintenance-requests' ? 'Permintaan Pemeliharaan' :
